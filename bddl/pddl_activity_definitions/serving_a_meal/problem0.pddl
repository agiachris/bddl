(define (problem serving_a_meal_0)
    ...
    (:goal
        (and
            ...
            (and
                (nextto spoon.n.01_1 soup.n.01_1)
                (nextto spoon.n.01_2 soup.n.01_2)
            )
            (forall
            ...
            (and
                ...
                (ontop chicken.n.01_2 plate.n.04_2)
            )
            (and
                (nextto salad.n.01_1 plate.n.04_1)
                (nextto salad.n.01_2 plate.n.04_2)
            )
            (and
                (nextto bread.n.01_1 plate.n.04_1)
                (nextto bread.n.01_2 plate.n.04_2)
            )
            (and
                (nextto cake.n.03_1 plate.n.04_1)
                (nextto cake.n.03_2 plate.n.04_2)
            )
        )
    )
)