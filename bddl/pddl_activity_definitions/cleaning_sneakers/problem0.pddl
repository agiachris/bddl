(define (problem cleaning_sneakers_0)
    ...
    (:goal
        (and
            ...
            (or
                (and
                    (nextto gym_shoe.n.01_1 table.n.02_1)
                    (nextto gym_shoe.n.01_2 table.n.02_1)
                )
                (and
                    (nextto gym_shoe.n.01_1 table.n.02_1)
                    (nextto gym_shoe.n.01_3 table.n.02_1)
                )
                (and
                    (nextto gym_shoe.n.01_1 table.n.02_1)
                    (nextto gym_shoe.n.01_4 table.n.02_1)
                )
                (and
                    (nextto gym_shoe.n.01_2 table.n.02_1)
                    (nextto gym_shoe.n.01_3 table.n.02_1)
            ...
            (or
                (and
                    ...
                    (under gym_shoe.n.01_2 table.n.02_1)
                )
                (and
                    (under gym_shoe.n.01_1 table.n.02_1)
                    (under gym_shoe.n.01_3 table.n.02_1)
                )
                (and
                    (under gym_shoe.n.01_1 table.n.02_1)
                    (under gym_shoe.n.01_4 table.n.02_1)
                )
                (and
                    (under gym_shoe.n.01_2 table.n.02_1)
                    (under gym_shoe.n.01_3 table.n.02_1)
