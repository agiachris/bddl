(define (problem serving_hors_d_oeuvres_0)
    ...
    (:goal
        (and
            ...
            (and
                (nextto salad.n.01_1 cracker.n.01_1)
                (nextto salad.n.01_2 cracker.n.01_2)
                (nextto salad.n.01_3 cracker.n.01_3)
                (nextto salad.n.01_4 cracker.n.01_4)
            )
            (and
                (ontop parsley.n.02_1 cheese.n.01_1)
                (ontop parsley.n.02_2 cheese.n.01_2)
                (ontop parsley.n.02_3 cheese.n.01_3)
                (ontop parsley.n.02_4 cheese.n.01_4)
            )
        )
    )
)