(define (problem filling_a_christmas_stocking_0)
    ...
    (:goal
        (and
            (and
                (inside cube.n.05_1 stocking.n.01_1)
                (inside cube.n.05_2 stocking.n.01_2)
                (inside cube.n.05_3 stocking.n.01_3)
                (inside cube.n.05_4 stocking.n.01_4)
            )
            (and
                (inside candy.n.01_1 stocking.n.01_1)
                (inside candy.n.01_2 stocking.n.01_2)
                (inside candy.n.01_3 stocking.n.01_3)
                (inside candy.n.01_4 stocking.n.01_4)
            )
            (and
                (inside pen.n.01_1 stocking.n.01_1)
                (inside pen.n.01_2 stocking.n.01_2)
                (inside pen.n.01_3 stocking.n.01_3)
                (inside pen.n.01_4 stocking.n.01_4)
            )
        )
    )
)