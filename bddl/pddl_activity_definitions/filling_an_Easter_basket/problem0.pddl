(define (problem filling_an_easter_basket_0)
    ...
    (:goal
        (and
            ...
            (and
                (inside egg.n.02_1 basket.n.01_1)
                (inside egg.n.02_2 basket.n.01_2)
            )
            (and
                (inside candy.n.01_1 basket.n.01_1)
                (inside candy.n.01_2 basket.n.01_2)
            )
            (exists
                (?basket.n.01 - basket.n.01)
                (and
            ...
            (and
                (or
                    (ontop bow.n.08_1 basket.n.01_1)
                    (inside bow.n.08_1 basket.n.01_1)
                )
                (or
                    (ontop bow.n.08_2 basket.n.01_2)
                    (inside bow.n.08_2 basket.n.01_2)
                )
            )
            (and
                (nextto book.n.02_1 basket.n.01_1)
                (nextto book.n.02_2 basket.n.01_2)
            )
        )
    )
)