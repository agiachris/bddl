(define (problem preparing_salad_0)
    ...
    (:goal
        (and
            (and
                (ontop lettuce.n.03_1 plate.n.04_1)
                (ontop lettuce.n.03_2 plate.n.04_2)
            )
            (and
                (and
                    (sliced apple.n.01_1)
                ...
                (and
                    (sliced apple.n.01_2)
                    (ontop apple.n.01_2 plate.n.04_2)
                )
            )
            (and
                (and
                    (ontop tomato.n.01_1 plate.n.04_1)
                    (sliced tomato.n.01_1)
                )
                (and
                    (ontop tomato.n.01_2 plate.n.04_2)
                    (sliced tomato.n.01_2)
                )
            )
            (and
                (ontop radish.n.01_1 plate.n.04_1)
                (ontop radish.n.01_2 plate.n.04_2)
            )
        )
    )
)